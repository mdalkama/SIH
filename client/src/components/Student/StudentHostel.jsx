                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white rounded-lg  border border-gray-300 shadow-sm p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <button onClick={() => setActiveModal('roomChange')} className="w-full text-left p-3 rounded-lg border hover:bg-gray-50 flex items-center gap-3"><Repeat className="w-5 h-5 text-orange-600"/> <p className="font-medium">Request Room Change</p></button>

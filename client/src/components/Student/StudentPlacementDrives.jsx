            ...
            <div className="bg-slate-50 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="flex items-center gap-3 p-4 bg-white rounded-lg border"><IndianRupee className="w-7 h-7 text-green-500 flex-shrink-0" /><div><p className="text-xs font-semibold text-slate-500 uppercase">Package</p><p className="font-bold text-slate-800">{drive.packageLPA} LPA</p></div></div>
                        <div className="flex items-center gap-3 p-4 bg-white rounded-lg border"><BookUser className="w-7 h-7 text-blue-500 flex-shrink-0" /><div><p className="text-xs font-semibold text-slate-500 uppercase">Eligible Courses</p><p className="font-bold text-slate-800">{drive.eligibleCourses.join(', ')}</p></div></div>
                        <div className="flex items-center gap-3 p-4 bg-white rounded-lg border"><Star className="w-7 h-7 text-amber-500 flex-shrink-0" /><div><p className="text-xs font-semibold text-slate-500 uppercase">Min. CGPA</p><p className="font-bold text-slate-800">{drive.minCGPA}</p></div></div>
                    </div>
                    <div>
                        <h3 className="font-semibold text-slate-800 mb-2 text-base">Job Description</h3>
                        <div className="prose prose-sm text-slate-600 max-w-none bg-white p-4 rounded-md border"><p>{drive.jobDescription}</p></div>
                    </div>
                </div>

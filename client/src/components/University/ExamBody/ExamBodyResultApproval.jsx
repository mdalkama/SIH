...
const ExamApprovalDashboard = () => {
    ...
    const handleViewResults = async (examId) => {
        ...
        finally { setIsViewingResults(false); }
    };
    ...
    return (
        ...
        <div className="font-sans">
            ...
            {selectedExamResults && (
                <ResultsViewerModal isOpen={!!selectedExamResults} onClose={() => setSelectedExamResults(null)} data={selectedExamResults} onPublish={handlePublish} isProcessing={isViewingResults} isPublishing={isPublishing} />
            )}
        </div>
    );
};

// --- Modal component for viewing results ---

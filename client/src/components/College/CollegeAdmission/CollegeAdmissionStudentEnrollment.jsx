            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="space-y-4 p-4 border rounded-md bg-slate-50/50">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 flex items-center pl-3 z-10"><Building2 className="h-5 w-5 text-slate-400" /></span>
                    <input id="twelfthBoard" name="twelfthBoard" value={formData.twelfthBoard} onChange={handleChange} type="text" placeholder="e.g., RBSE / CBSE" required className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none transition-all duration-300" />
                  </div>
                </div>
                {/* 12th Year */}
                <div className="relative">
                  ...
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 flex items-center pl-3 z-10"><Calendar className="h-5 w-5 text-slate-400" /></span>
                    <input id="twelfthYear" name="twelfthYear" value={formData.twelfthYear} onChange={handleChange} type="text" pattern="[0-9]{4}" placeholder="e.g., 2023" required className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none transition-all duration-300" />
                  </div>
                </div>
                {/* 12th Percentage */}
                <div className="relative">
                  ...
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 flex items-center pl-3 z-10"><Hash className="h-5 w-5 text-slate-400" /></span>
                    <input id="twelfthPercentage" name="twelfthPercentage" value={formData.twelfthPercentage} onChange={handleChange} type="text" placeholder="e.g., 85.2" required className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none transition-all duration-300" />
                  </div>
                </div>
              </div>
            </div>

...
const PromotionOrdersPage = () => {
  ...
  const getPromotionBadge = (type) => {
    const typeClasses = {
      'Provisional': 'bg-yellow-100 text-yellow-800 :bg-yellow-900/30 :text-yellow-300',
      'Regular': 'bg-green-100 text-green-800 :bg-green-900/30 :text-green-300',
      'General': 'bg-blue-100 text-blue-800 :bg-blue-900/30 :text-blue-300'
    };

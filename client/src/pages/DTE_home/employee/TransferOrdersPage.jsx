...
const TransferOrdersPage = () => {
  ...
  const getTransferBadge = (type) => {
    const typeClasses = {
      'Gazetted': 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
      'Non-Gazetted': 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
      'General': 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
      '2022-23': 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300',
      '2023-24': 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300'
    };
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {filteredTransferOrders.length > 0 ? (
                  filteredTransferOrders.map((item, index) => {
                    ...
                    return (
                      <tr key={`${item.year}-${index}`} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
